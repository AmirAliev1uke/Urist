...
4. Отвечай СТРОГО в формате JSON по указанной схеме. Без markdown-обёрток, без
...
{{
  ...
  "recommendations": [
    {{"text": "конкретная рекомендация", "category": "compliance|risk|missing_clause|wording|general"}}
  ],
  "risks": [
    {{"text": "описание риска", "severity": "high|medium|low", "quote": "точная цитата из документа"}}
  ],
  "highlights": [
